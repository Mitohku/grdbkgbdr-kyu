...
async def about(self):
    ...
    cpu_speed = int(float("{0[2]}".format(psutil.cpu_freq()))) / 1000
    mem = int(float(psutil.virtual_memory().total)) / 1000000000
    memory_total = mem - 1
