...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if not os.environ.get('MzkwNDc4OTk5ODI4MDM3NjMy.DR2NJQ.TYHUmQL_zQg3BbIIG0lqUoeY-g0'):
    print("no token found!")
bot.run(os.environ.get('MzkwNDc4OTk5ODI4MDM3NjMy.DR2NJQ.TYHUmQL_zQg3BbIIG0lqUoeY-g0').strip('"'))
